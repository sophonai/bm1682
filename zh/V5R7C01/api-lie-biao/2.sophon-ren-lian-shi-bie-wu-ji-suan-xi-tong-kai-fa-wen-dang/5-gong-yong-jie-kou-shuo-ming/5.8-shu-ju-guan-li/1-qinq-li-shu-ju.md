...
|              | smart_settings | bool | 可选 | 是否还原智能设置<br />true: 还原智能设置<br />false: 不还原智能设置 |      |
...
```json
{
	"wipe_options":{
        ...
        "smart_settings":true,  //true为还原智能设置
...
|          |              | smart_settings | bool | 是否还原智能设置<br />true: 还原智能设置<br />false: 不还原智能设置 |
